...
% 自定义标题
\titleformat{\subsubsection}[block]{\normalsize\normalfont\bfseries}{\arabic{subsubsection})}{1em}{}[]
...
% 三种盒子
\newtcolorbox{info}{
    breakable,enhanced, frame hidden, colback=LightSkyBlue!30!white,left=1mm,
    extras={frame hidden, colback=LightSkyBlue!30!white,left=1mm}}
